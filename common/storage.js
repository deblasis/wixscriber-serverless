...
const blobServiceClient = new BlobServiceClient(storageAddress('blob'), ankCred);
const jobsTableClient = new TableClient(storageAddress('table'), jobsTableName, sskCred);
